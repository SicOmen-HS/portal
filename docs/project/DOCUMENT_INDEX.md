...
| Deployment model / hosting architecture decision (e.g. containerization, a persistent portal instance) | [`docs/adr/0007-containerbaserad-deployment-persistent-portalinstans.md`](../adr/0007-containerbaserad-deployment-persistent-portalinstans.md), [`docs/11_ADR_mall.md`](../11_ADR_mall.md) | ADR-0007 owns the Portal/Hosting Lab boundary and the containerbaserad-vs-systemd decision; status Föreslagen |
...
| [`docs/adr/0007-containerbaserad-deployment-persistent-portalinstans.md`](../adr/0007-containerbaserad-deployment-persistent-portalinstans.md) | Decision (accepted): a persistent portal instance in the lab environment shall be container-based, with an explicit Portal/Data Platform vs. Hosting Lab ownership boundary | Any change to the portal's deployment model, containerization, or the Portal/Hosting Lab boundary | `docs/04_Systemarkitektur.md`, `docs/10_Release_och_deployment.md`, `docs/work-items/AB-033.md`, `docs/work-items/AB-034.md` |
