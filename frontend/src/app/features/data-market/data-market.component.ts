...
const ACTIONS: DataMarketAction[] = [
  ...
  { title: 'Skapa eller förändra dataunderlag', description: 'Initiera en ny datamängd eller beskriv en förändring av befintlig data.', icon: 'bi-database-add', link: ['/bestall', 'order-type-change-dataset'], linkLabel: 'Beskriv dataförändring', note: 'Ny datamängd finns också i beställningskatalogen.' },
  { title: 'Använd data i rapport eller dashboard', description: 'Gå vidare till tjänsten Rapporter och dashboards med ett rapportbehov.', icon: 'bi-bar-chart-line', link: ['/tjanster', 'rapporter-och-dashboards', 'skapa-ny-rapport-dashboard'], linkLabel: 'Skapa rapport eller dashboard' },
